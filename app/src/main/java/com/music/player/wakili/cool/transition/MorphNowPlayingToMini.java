...
package com.music.player.wakili.cool.transition;
...
public class MorphNowPlayingToMini extends ChangeBounds {
    ...
    public MorphNowPlayingToMini() {
        super();
    }

    public MorphNowPlayingToMini(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
